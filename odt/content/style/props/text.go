...
func (t *TextProps) Generate() string {
	...
	return fmt.Sprintf(`<style:text-properties style:font-name="%s" style:font-name-complex="%s" fo:font-size="%spt" style:font-size-asian="%spt" style:font-size-complex="%spt" fo:language="%s" fo:country="%s"/>`,
